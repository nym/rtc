...
// Per-worker cadence — tuned so the worker has time to walk out (≈4s at 1.44 u/s)
// to a patch at r=5.5 before the harvest event flips it to "carrying".
const THINK_MS = 600;
...
async function runWorker(
  ...
  // Stagger cycles so the workers aren't lockstep.
